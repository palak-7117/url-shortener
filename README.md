# ⚡ SwiftURL | Cyberpunk URL Shortener & QR Generator

A high-performance, responsive web application built with **Flask (Python)** and **SQLite** featuring a sleek, ambient Cyberpunk user interface. SwiftURL lets users instantly shorten long links, create secure custom aliases, and dynamically generate high-quality QR codes for on-the-go scanning. Fully optimized with automated unit testing suites and cloud-ready infrastructure.
...
## ✨ Features
* 🌌 **Sleek Cyberpunk UI:** Stunning modern aesthetics featuring reactive glassmorphic components, background matrix canvas configurations, and automated interactive 3D perspective tilting cards.
...
* **Frontend:** HTML5, CSS3 Variables, JavaScript (Vanilla ES6), Canvas API
